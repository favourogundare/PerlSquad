...
function eventScavengerHunt() {
    ...
    /**
     *@function this.onOK2
     *Extended function that handles when Item Info OK2 is clicked by moving the default highlighted/selected option to the first button still available if there are remaining items or by removing the infoContainer and calling game.progress().
     */
